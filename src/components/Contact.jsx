...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_gh1d2rs", // service_id
        "template_vsufbea", // template_id
        {
          // object with some options
          from_name: form.name,
          to_name: "James",
          from_email: form.email,
          to_email: "mercurys1030@gmail.com",
          message: form.message,
        },
        "gFfnsb3LFEecbAZLv" // public_key in emailjs
      )
      .then(
        () => {
          setLoading(false);
      ...
      >
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              ...
              <a
                onClick={() => copyToClipboard("live:.cid.943760d1f45712f1")}
                className="underline cursor-pointer"
              >
                live:.cid.943760d1f45712f1
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              ...
              <a
                onClick={() => copyToClipboard("god_10140303")}
                className="underline cursor-pointer"
              >
                god_10140303
              </a>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">devstar1014</p>
              <a
                href="https://github.com/devstar1014"
                target="_blank"
                className="underline cursor-pointer"
              >
                https://github.com/devstar1014
              </a>
            </div>
          </div>
        </div>
